    ...
    class ProductAddForm {
      ...
      updateAddToCartState(formState) {
        ...
        formWrapper?.forEach((element) => {
          ...
          const selling_plan_price = element.querySelector('.subscription-purchase-price .subscription-price');
          const single_purchase_price = element.querySelector('.single-purchase-price .single-price');
          const single_purchase_compare_price = element.querySelector('.single-purchase-price s');
          const selling_plan_compare_price = element.querySelector('.subscription-purchase-price s');
          const atcPrice = element.querySelector('.calculate-price');
          const atcStickyPrice = document.querySelector('.mobile-sticky-atc .atc-amount');
          const product__subs = element.querySelector('.product__subs input:checked');
          ...
          if(single_purchase_compare_price){
            ...
            single_purchase_compare_price.innerText = themeCurrency.formatMoney(variant.compare_at_price, theme.moneyFormat);
          }
